...
def assign_eval(ds_dict, raw_res_pth, num_classes, class_ids, scoreThresh=0.2, iouThresh=0.5, gtLabel_mapping=None):
    ...
    for imIdx, im in enumerate(tqdm.tqdm(testDataset, total = lenDataset)):
        ...
        allData = assign_types(allData, allDets, gtData, clsCutoff=class_ids, iouThresh=iouThresh)

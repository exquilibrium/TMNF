...
from flowDet_mmdet.utils.gmmDet_utils_custom import run_inference ################################################# custom
...
def main(argparse):
    ...
    if "XML" in cfg.dataset_type and argparse.subset == "train": # All custom scripts with XMLDataset will go here
        ds_subsets = ["trainCS"]

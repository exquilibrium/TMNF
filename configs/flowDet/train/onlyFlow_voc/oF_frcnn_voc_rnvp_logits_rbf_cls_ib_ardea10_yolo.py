_base_ = ['../../feat_ext/faster_rcnn_r50_fpn_voc0712OS_clsLogits_ardea10.py']
flow_params=dict(
    random_seed = 3,
	num_cls = 3, ### <<<<<<<<<<---------- NUM CS CLASSES +1 background class (0 because yolo here)---------->>>>>>>>>> 
	flow_type = "rnvp", # "rnvp", "residual", "nsf_ar"
	input_dim = 3, ### <<<<<<<<<<---------- NUM CS CLASSES +1---------->>>>>>>>>> 
	blocks = 16,
	hidden_dim = 64,
	num_layers_st_net = 4,
